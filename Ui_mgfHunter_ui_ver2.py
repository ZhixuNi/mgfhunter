...
class Ui_mgfHunterGUI(object):
    def setupUi(self, mgfHunterGUI):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 130, 671, 41))
        ...
        self.ConName_txt.setGeometry(QtCore.QRect(100, 10, 571, 31))
        ...
        self.Con_profile_List_txt.setGeometry(QtCore.QRect(100, 50, 571, 31))
        ...
        self.inSetFile_PB.setGeometry(QtCore.QRect(10, 220, 300, 30))
        self.inSetFile_PB.setObjectName(_fromUtf8("inSetFile_PB"))
        self.inSetFile_txt = QtGui.QTextEdit(self.Config_Tab)
        self.inSetFile_txt.setGeometry(QtCore.QRect(310, 220, 371, 31))
        ...
        self.ShowTypeList_txt.setGeometry(QtCore.QRect(170, 260, 511, 31))
        ...
        self.ShowFullSettings_txt.setGeometry(QtCore.QRect(10, 320, 671, 211))
        ...
        self.formLayoutWidget_5.setGeometry(QtCore.QRect(10, 80, 661, 231))
        ...
        self.Filter_in_PB.setMaximumSize(QtCore.QSize(300, 30))
        ...
        self.Filter_out_PB.setMaximumSize(QtCore.QSize(300, 30))
        ...
        self.Filter_run_PB.setMaximumSize(QtCore.QSize(300, 30))
        ...
        self.line_2.setGeometry(QtCore.QRect(10, 300, 601, 16))
        self.line_2.setFrameShape(QtGui.QFrame.HLine)
        self.line_2.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_2.setObjectName(_fromUtf8("line_2"))
        self.formLayoutWidget_6 = QtGui.QWidget(self.mgfHunter_Tab)
        self.formLayoutWidget_6.setGeometry(QtCore.QRect(10, 350, 661, 171))
        ...
        self.extractor_in_PB.setMaximumSize(QtCore.QSize(300, 30))
        ...
        self.extractor_out_PB.setMaximumSize(QtCore.QSize(300, 30))
        ...
        self.extractor_run_PB.setMaximumSize(QtCore.QSize(300, 30))
        ...
        self.hunterBanner_LB.setGeometry(QtCore.QRect(180, 0, 261, 31))
        ...
        self.horizontalLayoutWidget_2 = QtGui.QWidget(self.mgfHunter_Tab)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 30, 581, 41))
        ...
        self.textEdit_2 = QtGui.QTextEdit(self.horizontalLayoutWidget_2)
        self.textEdit_2.setMaximumSize(QtCore.QSize(40, 30))
        ...
        self.textEdit.setMaximumSize(QtCore.QSize(40, 30))
        self.textEdit.setObjectName(_fromUtf8("textEdit"))
        self.horizontalLayout_2.addWidget(self.textEdit)
        self.label_4 = QtGui.QLabel(self.horizontalLayoutWidget_2)
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.horizontalLayout_2.addWidget(self.label_4)
        self.textEdit_3 = QtGui.QTextEdit(self.horizontalLayoutWidget_2)
        self.textEdit_3.setMaximumSize(QtCore.QSize(40, 30))
        ...
        self.label.setGeometry(QtCore.QRect(10, 610, 391, 16))
    ...
    def retranslateUi(self, mgfHunterGUI):
        ...
        self.label_3.setText(_translate("mgfHunterGUI", "RT range-->  from:", None))
        self.label_2.setText(_translate("mgfHunterGUI", "to", None))
        self.label_4.setText(_translate("mgfHunterGUI", "unit(Sec/Min):", None))
...
if __name__ == "__main__":
    ...
    mgfHunter = QtGui.QDialog()
    ui = Ui_mgfHunterGUI()
    ui.setupUi(mgfHunter)
    mgfHunter.show()
    #sys.exit(app.exec_())
    sys.exit()
#-----------------------------------------------End script-----------------------------------#
